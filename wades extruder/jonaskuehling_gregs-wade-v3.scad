	...
	difference (){
		union(){
			...
			translate(idler_fulcrum){
                ...
                translate([-idler_hinge_r, -15, -(idler_short_side-2*idler_hinge_width-0.5)/2]) cube([15, 15, idler_short_side-2*idler_hinge_width-0.5]);
			}
			...
			/*translate(idler_fulcrum){
                ...
                difference(){
                    ...
                    rotate(15) translate([-idler_hinge_r*2+14.25, -15+idler_hinge_r, 0]) cube([15, 15, wade_block_depth/2-
                        idler_short_side/2+
                        idler_hinge_width+0.25+
                        layer_thickness]);
                }
